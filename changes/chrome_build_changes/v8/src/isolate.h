...
#undef ISOLATE_FIELD_OFFSET
  ...
  public:
    ...
    static void staticGCPrologue(v8::Isolate * isolate, GCType type, GCCallbackFlags flags);
    static void staticGCEpilogue(v8::Isolate * isolate, GCType type, GCCallbackFlags flags);
