...
function runRevComp(size) {

var input = read("/home/airjack/level4/SociableJavascript/benchmarks/200000").split("/n");

var lineNum = 0;

write(input[lineNum++]);

for (line = input[lineNum++]; lineNum < input.length; line = input[lineNum++]) {
    if (line[0] !== '>') {
