...
function readInput() {
    ...
    // Places input file contents into string
    var input = read("/home/airjack/level4/SociableJavascript/benchmarks/200000").split("\n");

    while (input[lineNum++].substr(0, 3) !== '>TH') {
    }
    ...
    do {
        ...
        i = 0;
    } while (lineNum < input.length && (line = input[lineNum++]) && line[0] !== '>')
}
...
load("/home/airjack/level4/SociableJavascript/benchmarks/run.js");
run(runKNucleotide,150,200000);